...
const icons = [
  faFacebookF, faTwitter, faLinkedinIn, faWhatsapp,faGooglePlusG, faPinterestP, faRedditAlien, faTumblr,
  faVk, faFacebookMessenger, faTelegramPlane, faMix, faXing, faCommentAlt,  faLine,
