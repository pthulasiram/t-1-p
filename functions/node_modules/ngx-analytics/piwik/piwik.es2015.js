...
var NgxAnalyticsPiwik = (function () {
    function NgxAnalyticsPiwik(ngxAnalytics$$1) {
        var _this = this;
    ...
    NgxAnalyticsPiwik.prototype.pageTrack = function (path, location) {
        try {
    ...
    NgxAnalyticsPiwik.prototype.eventTrack = function (action, properties) {
    ...
    NgxAnalyticsPiwik.prototype.setUsername = function (userId) {
        try {
    ...
    NgxAnalyticsPiwik.prototype.setUserProperties = function (properties) {
    ...
    NgxAnalyticsPiwik.prototype.setCustomDimensions = function (properties) {
    ...
    NgxAnalyticsPiwik.decorators = [
        { type: Injectable },
    ];
    NgxAnalyticsPiwik.ctorParameters = function () { return [
        { type: NgxAnalytics, },
    ]; };
    return NgxAnalyticsPiwik;
}());

export { NgxAnalyticsPiwik };
